...
|-------------------------------------------------------------|-------------------------------------------------------|-------------------------------------------------------|---------------------------------------------------------|
| <a href="https://github.com/Yesh01/PersonalWebTravelBlog" style="text-decoration: none; color: #0A58D0;">**Travel-Blog-Site**</a> – Refresher Project into Web Trio in the theme of Travel-Blog. | <div style="border: 2px solid #0A58D0; padding: 5px;">**Py [Shifting]**, **Linux Environment**, **Web Development [Pause]**, and **laylow for now.**.</div> | <a href="https://github.com/Yesh01/AuctionOnline" style="text-decoration: none; color: #0A58D0;">**Auction System Using JavaFX**</a>. | Check out all my projects at my <a href="https://github.com/Yesh01?tab=repositories" style="text-decoration: none; color: #0A58D0;">**GitHub Repositories**</a>. |
...
<p align="center">
  <a href="https://app.daily.dev/yeshuavenezuela">
    <img src="https://api.daily.dev/devcards/v2/nkp19dStW1rzN0TQLLryt.png?type=wide&r=a0i" width="652" alt="Yearu's Dev Card"/>
  </a>
</p>
